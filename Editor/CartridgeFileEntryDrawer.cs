...
namespace OneJS.Editor {
    [CustomPropertyDrawer(typeof(CartridgeFileEntry))]
    public class CartridgeFileEntryDrawer : PropertyDrawer {
        ...
        string GetSeparatorFromParent(SerializedProperty property) {
            ...
            // Property path for array element looks like: "_files.Array.data[0]"
            // We need to get the field info for "_files"
