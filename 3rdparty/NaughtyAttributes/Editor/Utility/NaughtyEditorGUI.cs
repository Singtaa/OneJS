...
namespace NaughtyAttributes.Editor
{
    public static class NaughtyEditorGUI
    {
        ...
        private static GUIStyle _buttonStyle = new GUIStyle(GUI.skin.button) { richText = true, margin = new RectOffset(0, 0, 5, 5)};
        ...
        public static void Button(UnityEngine.Object target, MethodInfo methodInfo)
        {
            ...
            if (methodInfo.GetParameters().All(p => p.IsOptional))
            {
                ...
                if (GUILayout.Button(buttonText, _buttonStyle, GUILayout.Height(buttonAttribute.Height)))
                {
