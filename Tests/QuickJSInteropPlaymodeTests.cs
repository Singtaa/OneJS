    ...
    public class QuickJSInteropPlaymodeTests {
        ...
        public IEnumerator ProxyCache_SameMethodCall_ReturnsSameProxy() {
            ...
            var result = _ctx.Eval(@"
                var a = CS.OneJS.Tests.InteropTestHelper.GetState();
                var b = CS.OneJS.Tests.InteropTestHelper.GetState();
                a === b;
            ");
        ...
        public IEnumerator ProxyCache_PropertyChangeVisibleThroughSameProxy() {
            ...
            var result = _ctx.Eval(@"
                var state = CS.OneJS.Tests.InteropTestHelper.GetState();
                var nameBefore = state.Name;
                CS.OneJS.Tests.InteropTestHelper.SetName('Town B');
        ...
        public IEnumerator ChangeDetection_ObjectIs_TrueForSameProxy() {
            ...
            var result = _ctx.Eval(@"
                var state1 = CS.OneJS.Tests.InteropTestHelper.GetState();
                CS.OneJS.Tests.InteropTestHelper.SetName('Town B');
                CS.OneJS.Tests.InteropTestHelper.SetVersion(2);
                var state2 = CS.OneJS.Tests.InteropTestHelper.GetState();
        ...
        public IEnumerator ChangeDetection_ExtractedPrimitives_DetectChanges() {
            ...
            var result = _ctx.Eval(@"
                var name1 = CS.OneJS.Tests.InteropTestHelper.GetState().Name;
                var ver1 = CS.OneJS.Tests.InteropTestHelper.GetState().Version;

                CS.OneJS.Tests.InteropTestHelper.SetName('Town B');
                CS.OneJS.Tests.InteropTestHelper.SetVersion(2);

                var name2 = CS.OneJS.Tests.InteropTestHelper.GetState().Name;
                var ver2 = CS.OneJS.Tests.InteropTestHelper.GetState().Version;
        ...
        public IEnumerator Enum_Constant_ResolvesToNumber() {
            var result = _ctx.Eval(@"
                var foo = CS.OneJS.Tests.InteropTestEnum.Foo;
                var bar = CS.OneJS.Tests.InteropTestEnum.Bar;
                (typeof foo) + '|' + foo + '|' + bar;
            ");
        ...
        public IEnumerator Enum_Constant_StrictEqualsItself() {
            var result = _ctx.Eval(@"
                CS.OneJS.Tests.InteropTestEnum.Bar === CS.OneJS.Tests.InteropTestEnum.Bar;
            ");
            Assert.AreEqual("true", result,
        ...
        public IEnumerator Enum_FieldValue_StrictEqualsConstant() {
            ...
            var result = _ctx.Eval(@"
                CS.OneJS.Tests.InteropTestHelper.SetMode(CS.OneJS.Tests.InteropTestEnum.Bar);
                var mode = CS.OneJS.Tests.InteropTestHelper.GetMode();
                (typeof mode) + '|' + (mode === CS.OneJS.Tests.InteropTestEnum.Bar) + '|' +
                    (mode === CS.OneJS.Tests.InteropTestEnum.Foo);
            ");
        ...
        public IEnumerator NullSafety_StateTransitionFromNullToObject() {
            var result = _ctx.Eval(@"
                var stateBefore = CS.OneJS.Tests.InteropTestHelper.GetState();
                var before = stateBefore?.Name ?? 'none';
                CS.OneJS.Tests.InteropTestHelper.Init('Village', 1);
                var stateAfter = CS.OneJS.Tests.InteropTestHelper.GetState();
        ...
        public IEnumerator Collection_ListCount_Works() {
            ...
            var result = _ctx.Eval(@"
                var items = CS.OneJS.Tests.InteropTestHelper.GetItems();
                '' + items.Count;
            ");
        ...
        public IEnumerator Collection_ToJSArrayLoop_Works() {
            ...
            var result = _ctx.Eval(@"
                var csList = CS.OneJS.Tests.InteropTestHelper.GetItems();
                var jsArr = [];
        ...
        public IEnumerator Collection_LiveUpdates_ReflectedInProxy() {
            ...
            var result = _ctx.Eval(@"
                ...
                CS.OneJS.Tests.InteropTestHelper.AddItem('added');
        ...
        public IEnumerator Array_Length_Works() {
            ...
            var result = _ctx.Eval(@"
                var arr = CS.OneJS.Tests.InteropTestHelper.GetItemsAsArray();
                '' + arr.Length;
            ");
        ...
        public IEnumerator Array_ToJSArrayLoop_Works() {
            ...
            var result = _ctx.Eval(@"
                var csArr = CS.OneJS.Tests.InteropTestHelper.GetItemsAsArray();
                var jsArr = [];
        ...
        public IEnumerator Combined_FullWorkflow_ProxyWithDepsAndCollection() {
            ...
            var result = _ctx.Eval(@"
                ...
                var deps1 = getDeps();
                var items1 = toArray(CS.OneJS.Tests.InteropTestHelper.GetItems());

                // Simulate game state change
                CS.OneJS.Tests.InteropTestHelper.SetName('Market');
                CS.OneJS.Tests.InteropTestHelper.SetVersion(2);
                CS.OneJS.Tests.InteropTestHelper.AddItem('cheese');

                var deps2 = getDeps();
                var items2 = toArray(CS.OneJS.Tests.InteropTestHelper.GetItems());
        ...
        public IEnumerator TypedCollection_ItemPropertyChange_VisibleThroughProxy() {
            ...
            var result = _ctx.Eval(@"
                ...
                CS.OneJS.Tests.InteropTestHelper.SetItemDurability(0, 75);
        ...
        public IEnumerator TypedCollection_ItemDepsDetectChange_OnlyAffectedItem() {
            ...
            var result = _ctx.Eval(@"
                ...
                CS.OneJS.Tests.InteropTestHelper.SetItemDurability(0, 50);
        ...
        public IEnumerator TypedCollection_CountChange_DetectedByParentDeps() {
            ...
            var result = _ctx.Eval(@"
                ...
                CS.OneJS.Tests.InteropTestHelper.AddInventoryItem(3, 'Potion', 1, 5);
        ...
        public IEnumerator TypedCollection_ItemMutation_DoesNotChangeCount() {
            ...
            var result = _ctx.Eval(@"
                ...
                CS.OneJS.Tests.InteropTestHelper.SetItemDurability(0, 50);
                CS.OneJS.Tests.InteropTestHelper.SetItemName(1, 'Broken Shield');
        ...
        public IEnumerator TypedCollection_RemoveItem_ChangesCount() {
            ...
            var result = _ctx.Eval(@"
                ...
                CS.OneJS.Tests.InteropTestHelper.RemoveInventoryItem(1);
        ...
        public IEnumerator TypedCollection_MultiplePropertyChanges_AllDetected() {
            ...
            var result = _ctx.Eval(@"
                ...
                CS.OneJS.Tests.InteropTestHelper.SetItemName(0, 'Broken Sword');
                CS.OneJS.Tests.InteropTestHelper.SetItemStackCount(0, 2);
