...
namespace OneJS.Tests {
    ...
    public class QuickJSPlaymodeTests {
        ...
        public IEnumerator Async_ImmediateTaskInt_ReturnsDirectly() {
            ...
            var result = _ctx.Eval(@"
                CS.OneJS.Tests.AsyncTestHelper.GetValueAsync(42);
            ");
        ...
        public IEnumerator Async_DelayedTaskString_ResolvesAfterDelay() {
            ...
            _ctx.Eval(@"
                ...
                var promise = CS.OneJS.Tests.AsyncTestHelper.DelayedMessageAsync('Hello Async', 50);
        ...
        public IEnumerator Async_TaskVoid_ResolvesWithNull() {
            ...
            _ctx.Eval(@"
                ...
                var __asyncDone = false;
                var promise = CS.OneJS.Tests.AsyncTestHelper.DoWorkAsync(50);
                promise.then(function(result) {
                    __asyncResult = result;
                    __asyncDone = true;
                });
        ...
        public IEnumerator Async_FailingTask_Rejects() {
            ...
            _ctx.Eval(@"
                ...
                var __asyncDone = false;
                var promise = CS.OneJS.Tests.AsyncTestHelper.FailingAsync('Test error message');
                promise.then(function(result) {
                    __asyncDone = true;
        ...
        public IEnumerator Async_TaskReturnsGameObject_WrapsAsHandle() {
            ...
            _ctx.Eval(@"
                var result = CS.OneJS.Tests.AsyncTestHelper.CreateGameObjectAsync('AsyncTestGO');
            ");
            _ctx.ExecutePendingJobs();
        ...
        public IEnumerator Async_AwaitSyntax_Works() {
            ...
            _ctx.Eval(@"
                ...
                (async function() {
                    try {
                        var result = await CS.OneJS.Tests.AsyncTestHelper.GetValueAsync(100);
                        __asyncResult = result;
                        __asyncDone = true;
                    } catch (e) {
        ...
        public IEnumerator Async_MultipleAwaits_Work() {
            ...
            _ctx.Eval(@"
                ...
                var __asyncDone = false;
                (async function() {
                    var a = await CS.OneJS.Tests.AsyncTestHelper.GetValueAsync(10);
                    var b = await CS.OneJS.Tests.AsyncTestHelper.GetValueAsync(20);
                    var c = await CS.OneJS.Tests.AsyncTestHelper.GetValueAsync(30);
                    __asyncResult = a + b + c;
                    __asyncDone = true;
                })();
            ");
        ...
        public IEnumerator Array_Float32Array_ToFloatArray_Works() {
            ...
            var result = _ctx.Eval(@"
                ...
                CS.OneJS.Tests.ArrayTestHelper.SumFloatArray(arr);
            ");
        ...
        public IEnumerator Array_Int32Array_ToIntArray_Works() {
            ...
            var result = _ctx.Eval(@"
                ...
                CS.OneJS.Tests.ArrayTestHelper.SumIntArray(arr);
            ");
        ...
        public IEnumerator Array_JsObjectArray_ToVector3Array_Works() {
            ...
            var result = _ctx.Eval(@"
                ...
                var sum = CS.OneJS.Tests.ArrayTestHelper.SumVector3Array(arr);
                sum.x + ',' + sum.y + ',' + sum.z;
            ");
        ...
        public IEnumerator Array_StringArray_Works() {
            ...
            var result = _ctx.Eval(@"
                var arr = ['Hello', ' ', 'World'];
                CS.OneJS.Tests.ArrayTestHelper.JoinStrings(arr);
            ");
            Assert.AreEqual("Hello World", result);
            yield return null;
        }
        ...
        public IEnumerator Long_ReturnZero_Works() {
            var result = _ctx.Eval("CS.OneJS.Tests.Int64TestHelper.GetLongZero()");
            Assert.AreEqual("0", result);
            yield return null;
        }
        ...
        public IEnumerator Long_ReturnSmallValue_Works() {
            var result = _ctx.Eval("CS.OneJS.Tests.Int64TestHelper.GetLongSmall()");
            Assert.AreEqual("42", result);
            yield return null;
        }
        ...
        public IEnumerator Long_ReturnNegative_Works() {
            var result = _ctx.Eval("CS.OneJS.Tests.Int64TestHelper.GetLongNegative()");
        ...
        public IEnumerator Long_ReturnMaxSafeInteger_Works() {
            var result = _ctx.Eval("CS.OneJS.Tests.Int64TestHelper.GetLongMaxSafe()");
        ...
        public IEnumerator Long_ReturnMinSafeInteger_Works() {
            var result = _ctx.Eval("CS.OneJS.Tests.Int64TestHelper.GetLongMinSafe()");
            Assert.AreEqual("-9007199254740991", result);
            yield return null;
        }
        ...
        public IEnumerator ULong_ReturnZero_Works() {
            var result = _ctx.Eval("CS.OneJS.Tests.Int64TestHelper.GetULongZero()");
            Assert.AreEqual("0", result);
            yield return null;
        }
        ...
        public IEnumerator ULong_ReturnSmallValue_Works() {
            var result = _ctx.Eval("CS.OneJS.Tests.Int64TestHelper.GetULongSmall()");
            Assert.AreEqual("42", result);
            yield return null;
        }
        ...
        public IEnumerator ULong_ReturnLargeValue_Works() {
            var result = _ctx.Eval("CS.OneJS.Tests.Int64TestHelper.GetULongLarge()");
            Assert.AreEqual("9007199254740991", result);
            yield return null;
        }
        ...
        public IEnumerator Long_RoundTrip_Works() {
            ...
            var result = _ctx.Eval("CS.OneJS.Tests.Int64TestHelper.EchoLong(12345)");
            Assert.AreEqual("12345", result);
            yield return null;
        }
        ...
        public IEnumerator ULong_RoundTrip_Works() {
            var result = _ctx.Eval("CS.OneJS.Tests.Int64TestHelper.EchoULong(67890)");
        ...
        public IEnumerator ULong_IsNumeric_NotObjectHandle() {
            ...
            var result = _ctx.Eval("typeof CS.OneJS.Tests.Int64TestHelper.GetULongSmall()");
